...
javac -cp .:lib/junit-4.13.2.jar:lib/hamcrest-core-1.3.jar ZorritoJUnitTest.java
if [ $? -ne 0 ]; then
...
java -Djava.awt.headless=true -cp .:lib/junit-4.13.2.jar:lib/hamcrest-core-1.3.jar org.junit.runner.JUnitCore ZorritoJUnitTest
if [ $? -ne 0 ]; then
